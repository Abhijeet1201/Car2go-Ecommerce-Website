...
<div>
  ...
  <nav class="navbar fixed-top navbar-expand-md bg-light navbar-light">
    <a class="navbar-brand" href="index.php"><img class="logo" src="images/logo_1.png" alt="" width="50" height="40" class="d-inline-block"/>&nbsp;&nbsp;Car2Go</a>
...
<section>
  <div class="jumbotron jumbotron-fluid section_divider text-center">
        <div class="container-fluid">
          <h1 class="title display-4">Used Cars on Sale</h1>
          </div>
          </div>
        </section>
              ...
              <div class="card h-100">
                <div class="card-body">
                  ...
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item">Price: £ <?= number_format($row['product_price'])?></li>
                    <li class="list-group-item">Mileage: <?= number_format($row['product_miles'])?></li>
                    <li class="list-group-item">Fuel type: <?= $row['product_fuel']?> </li>
